...
\\[-1.8ex]\hline 
\hline 
\\[-1.8ex] & \multicolumn{1}{c}{Full Sample} & \multicolumn{1}{c}{Resident}& \multicolumn{1}{c}{NSFH}& \multicolumn{1}{c}{NSFG} \Writing to file mpc.tex
Processing code chunks with options ...

You can now run (pdf)latex on ‘mpc.tex’
}{c}{(4)}\\ 
\hline \\[-1.8ex] 
